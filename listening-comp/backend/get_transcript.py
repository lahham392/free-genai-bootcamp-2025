...
class YouTubeTranscriptDownloader:
    def __init__(self, languages: List[str] = ["es", "ar"]):
...
if __name__ == "__main__":
    video_id = "https://www.youtube.com/watch?v=NG9i48Ehfbc&ab_channel=LingoMasterySpanish"  # Extract from URL: XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
